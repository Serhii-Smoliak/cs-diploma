...
const CodeEditor = memo(function CodeEditor({ level }: CodeEditorProps) {
      ...
      {isRegexTask ? (
        <div>
          ...
          <input
            ...
            placeholder={level.work_area.placeholder || t('enterRegexPatternPlaceholder', { ns: 'tasks' })}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                {isSuccess ? (
                  ...
                  <div>
                    <div className="text-cyber-danger font-bold text-lg mb-2">{result.startsWith(t('error', { ns: 'tasks' })) ? t('error', { ns: 'tasks' }).replace(':', '') : t('failureTitle', { ns: 'tasks' })}</div>
                    <pre className="whitespace-pre-wrap font-mono text-sm text-cyber-danger mb-3">
                      {result.replace(`${t('failure', { ns: 'tasks' })}\n`, '').replace(`${t('error', { ns: 'tasks' })}\n`, '')}
                    </pre>
