...
export const FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    items: [
      ...
      { id: 'howMissions', questionKey: 'items.howMissions.question', answerKey: 'items.howMissions.answer' },
      ...
      { id: 'skillMatrix', questionKey: 'items.skillMatrix.question', answerKey: 'items.skillMatrix.answer' },
      { id: 'hints', questionKey: 'items.hints.question', answerKey: 'items.hints.answer' },
      { id: 'leaderboard', questionKey: 'items.leaderboard.question', answerKey: 'items.leaderboard.answer' },
      { id: 'language', questionKey: 'items.language.question', answerKey: 'items.language.answer' },
    ],
  },
  {
    id: 'missionTypes',
    ...
    items: [
      { id: 'codeEditor', questionKey: 'items.codeEditor.question', answerKey: 'items.codeEditor.answer' },
      { id: 'tacticalChoice', questionKey: 'items.tacticalChoice.question', answerKey: 'items.tacticalChoice.answer' },
      {
